...
class Cell(Agent):
    ...
    def __init__(self, position, model, initial_state = CellState.SUSCEPTIBLE):
        ...
        self.infectiousness              = 0.0 # Infectivity
    ...
    def step(self):
        ...
        if self.state == CellState.SUSCEPTIBLE:
            ...
            logging.debug(f'TOTAL INFECTIVITY IS {total_infectiousness}')

            infprob = 0.0
            # This deals with the evolution of the disease.
            if total_infectiousness > 0:
                infprob = total_infectiousness / (total_infectiousness + self.model.h_inf)
            ...
            if random.random() < infprob:
                ...
                for neighbor in neighbors:
                    if neighbor.state == CellState.SUSCEPTIBLE:
                        ...
                        infprobsum += neighbor.infectiousness
            ...
            # random.choices(neigbors, weights=(neighbors weighted by infectiousness))
            # Infectiousness
